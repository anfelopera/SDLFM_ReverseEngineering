function [g1, g2] = simXsimKernGradient(simKern1, simKern2, t1, t2, covGrad, meanVector)
...
%	  COVGRAD - gradient of the objective function with respect to the
%	   elements of the cross kernel matrix.
%     MEANVECTOR - precomputed factor that is used for the switching dynamical
%      single input motif
%
%	See also
...
subComponent = false; % This is just a flag that indicates if this kernel is part of a bigger kernel (SDSIM)
...
if subComponent
    if size(meanVector,1) ==1,
        dh1_dD1 = dh1_dD1*meanVector;
        dh1_dD2 = dh1_dD2*meanVector;
        dh1_dsigma = dh1_dsigma*meanVector;        
        dh2_dD1 = meanVector'*dh2_dD1;
        dh2_dD2 = meanVector'*dh2_dD2;
        dh2_dsigma = meanVector'*dh2_dsigma;
    else
        dh1_dD1 = (meanVector*dh1_dD1).';
        dh1_dD2 = (meanVector*dh1_dD2).';
        dh1_dsigma = (meanVector*dh1_dsigma).';        
        dh2_dD1 = (dh2_dD1*meanVector').';
        dh2_dD2 = (dh2_dD2*meanVector').';
        dh2_dsigma = (dh2_dsigma*meanVector').';
    end
end
