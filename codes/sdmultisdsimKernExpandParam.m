function kern = sdmultisdsimKernExpandParam(kern, params)

% SDMULTISDSIMKERNEXPANDPARAM Expands parameters into a SDMULTI kernel struct for
% SDSIM kernel.
% FORMAT
...
kern.LIC = reshape(params(startVal:end), 1*kern.numPositions, 1*kern.numPositions);    
