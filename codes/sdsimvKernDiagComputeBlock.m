function k = sdsimvKernDiagComputeBlock(simKern, t, kyy)

% SDSIMVKERNCOMPUTEBLOCK Diagonal of a SDSIM kernel matrix for block i
% FORMAT
...
% ARG simKern : structure containing parameters for the system
...
g1 = sdsimvMeanCompute(simKern(1), t);

k = kyy*(g1.^2);

for i=1:length(simKern)
    k  = k + simvKernDiagCompute(simKern(i), t);
end