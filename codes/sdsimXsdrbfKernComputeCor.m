function [K, Kc] = sdsimXsdrbfKernComputeCor(sdsimKern, sdrbfKern, t1, t2, type)
...
for q=1:sdrbfKern.nlfPerInt
    ...
    for i=1:sdsimKern.nIntervals
        ...
        for j=1:i
            ...
            % multiplying the kernel with the corresponding sensitivity
            tK(startValOne:endValOne, startValThree:endValThree)  = ...
                exp(sdsimKern.sensitivity(q,i)) * ...
                tK(startValOne:endValOne, startValThree:endValThree); 
