function kern = sdmultisdsimKernParamInit(kern, options)

% SDMULTIKERNPARAMINIT SDMULTI kernel parameter initialisation for SDSIM.
...
kern.comp{1}.LIC = eye(1*kern.comp{1}.numPositions);
kern.comp{1}.nParams = kern.comp{1}.nParams + (1*kern.comp{1}.numPositions)^2;        
