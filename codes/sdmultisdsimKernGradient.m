function g = sdmultisdsimKernGradient(kern, x, x2, covGrad)

% SDMULTISDSIMKERNGRADIENT Gradient of SDMULTI kernel's parameters for SDSIM.
% FORMAT
...
covGradIC = finalCovkyy;
Jij = zeros(1*kern.numPositions);
Jji = zeros(1*kern.numPositions);
gIC = zeros(1*kern.numPositions);
